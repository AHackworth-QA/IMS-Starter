...
public enum Action {
	...
	UPDATE("To change an entity already in the database"), DELETE("To remove an entity from the database"), ADD_ITEMS("To add items to orders (specific to orders)"), DELETE_ITEMS("To delete items from orders (specific to orders)"),
